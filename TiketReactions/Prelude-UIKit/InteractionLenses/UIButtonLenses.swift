...
public extension LensHolder where Object: UIButtonProtocol {
    ...
    func attributedTitle(forState state: UIControlState) -> Lens<Object, NSAttributedString> {
        return Lens(
    ...
    func backgroundColor(forState state: UIControlState) -> Lens<Object, UIColor> {
        return Lens(
            view: { _ in .clear },
    ...
    func backgroundImage(forState state: UIControlState) -> Lens<Object, UIImage?> {
        return Lens(
    ...
    func image(forState state: UIControlState) -> Lens<Object, UIImage?> {
        return Lens(
    ...
    func titleColor(forState state: UIControlState) -> Lens<Object, UIColor> {
        return Lens(
    ...
    func title(forState state: UIControlState) -> Lens<Object, String?> {
        return Lens(
